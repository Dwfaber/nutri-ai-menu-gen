-- Renomear apenas as colunas que precisam ser alteradas na tabela co_solicitacao_produto_listagem
-- para coincidir com os nomes da view CoSolicitacaoProdutoListagem

-- Renomear categoria_id para solicitacao_produto_categoria_id
ALTER TABLE public.co_solicitacao_produto_listagem 
RENAME COLUMN categoria_id TO solicitacao_produto_categoria_id;

-- Renomear apenas_valor_inteiro para apenas_valor_inteiro_sim_nao
ALTER TABLE public.co_solicitacao_produto_listagem 
RENAME COLUMN apenas_valor_inteiro TO apenas_valor_inteiro_sim_nao;

-- Renomear em_promocao para em_promocao_sim_nao
ALTER TABLE public.co_solicitacao_produto_listagem 
RENAME COLUMN em_promocao TO em_promocao_sim_nao;

-- Renomear produto_base_qtd_embalagem para produto_base_quantidade_embalagem
ALTER TABLE public.co_solicitacao_produto_listagem 
